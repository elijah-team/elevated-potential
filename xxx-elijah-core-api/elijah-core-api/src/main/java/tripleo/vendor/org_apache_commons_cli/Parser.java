...
public abstract class Parser implements CommandLineParser {
	 ...
	 */
	@Override
	public CommandLine parse(final @NotNull Options options, final String[] arguments, final boolean stopAtNonOption)
			throws ParseException {
	 ...
	 * @since 1.1
	 */
	public CommandLine parse(final @NotNull Options options, final String[] arguments, final Properties properties)
			throws ParseException {
	 ...
	 * @since 1.1
	 */
	public CommandLine parse(final @NotNull Options options, String @Nullable [] arguments, final Properties properties,
	 ...
	 * values retrieved from the specified iterator {@code iter}.
	 *
	 ...
	 * the specified iterator {@code iter}.
	 *
	 ...
	 *                        the properties.
	 */
	protected void processProperties(final @Nullable Properties properties) throws ParseException {
		if (properties == null) {
			return;
		}
