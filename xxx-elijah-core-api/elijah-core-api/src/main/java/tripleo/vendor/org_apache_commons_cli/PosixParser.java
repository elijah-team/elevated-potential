...
//	 * <li>if the current {@code arguments} entry is "<b>--</b>" just add the entry
...
//	 * valid id and {@code stopAtNonOption} is true, then the remaining entries are
//	 * copied to the list of processed tokens. Otherwise, the current entry is
//	 * ignored.</li>
//	 * <li>if the current {@code arguments} entry is more than two characters in
//	 * length and the first character is "<b>-</b>" then we need to burst the entry
//	 * to determine its constituents. For more information on the bursting algorithm
//	 * see {@link PosixParser#burstToken(String, boolean) burstToken}.</li>
//	 * <li>if the current {@code arguments} entry is not handled by any of the
//	 * previous rules, then the entry is added to the list of processed tokens.</li>
//	 * </ol>
//	 *
...
//
//	/**
//	 * Resets the members to their original state i.e. remove all of {@code tokens}
//	 * entries and set {@code eatTheRest} to false.
//	 */
//	private void init() {
//		eatTheRest = false;
//		tokens.clear();
...
//
//	/**
//	 * Add the special token "<b>--</b>" and the current {@code value} to the
//	 * processed tokens list. Then add all the remaining {@code argument} values to
...
//	/**
//	 * <p>
//	 * If an {@link Option} exists for {@code token} then add the token to the
//	 * processed list.
//	 * </p>
//	 *
//	 * <p>
//	 * If an {@link Option} does not exist and {@code stopAtNonOption} is set then
//	 * add the remaining tokens to the processed tokens list directly.
//	 * </p>
//	 *
//	 * @param token           The current option token
//	 * @param stopAtNonOption Specifies whether flattening should halt at the first
//	 *                        non option.
//	 */
