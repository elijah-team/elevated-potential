...
public class DlogEvaluator implements IEvaluator {
     ...
     */
    @Deprecated
    public Collection<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> _query(String predicateName, int arity) {
     ...
     */
    @Deprecated
    public Collection<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> _query(String predicateName, int arity, String[] params) {

        Collection<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> factsForEvaluation = evaluateRules();
        ...
        Collection<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> result = new ArrayList<tripleo.vendor.com.github.dritter.hd.dlog.IFacts>();

        final Iterator<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> fIt = factsForEvaluation.iterator();

        // Filter result of rule evaluation according to query
        while (fIt.hasNext()) {
            final tripleo.vendor.com.github.dritter.hd.dlog.IFacts f = fIt.next();
    ...
    public IFacts query(String predicateName, int arity, String[] params) {
        ...
        Collection<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> result = _query(predicateName, arity, params);

        final Iterator<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> fIt = result.iterator();
    ...
    private void processValues(final List<List<ParameterValue<?>>> values, final tripleo.vendor.com.github.dritter.hd.dlog.IFacts f, String[] params) {
     ...
     */
    @Deprecated
    public List<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> transformFacts(Collection<IFacts> facts) {
        final List<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> fs = new ArrayList<tripleo.vendor.com.github.dritter.hd.dlog.IFacts>(facts.size());
     ...
     */
    @Deprecated
    public void _initalize(final Collection<tripleo.vendor.com.github.dritter.hd.dlog.IFacts> facts, final String rules) {
        this.factsNew = facts;
        this.rules = rules;
    }
