...
public class ElijjahParser extends antlr.LLkParser implements ElijjahTokenTypes {
	...
	public static final String[] _tokenNames = { "<0>", "EOF", "<2>", "NULL_TREE_LOOKAHEAD", "\"as\"", "\"cast_to\"",
			...
			"NUM_FLOAT", "DOT", "\"extend\"", "\"class\"", "LBRACK", "RBRACK", "\"const\"", "\"struct\"",
			"\"signature\"", "\"interface\"", "\"abstract\"", "\"annotation\"", "\"exception\"", "LPAREN", "RPAREN",
			"LCURLY", "RCURLY", "\"type\"", "BECOMES", "BOR", "ANNOT", "\"namespace\"", "\"from\"", "\"import\"",
			"COMMA", "LT_", "\"constructor\"", "\"ctor\"", "\"destructor\"", "\"dtor\"", "\"continue\"", "\"break\"",
			"\"return\"", "\"with\"", "\"pre\"", "\"requires\"", "\"post\"", "\"ensures\"", "\"def\"", "\"immutable\"",
			"TOK_ARROW", "\"var\"", "\"val\"", "\"alias\"", "\"yield\"", "\"construct\"", "SEMI", "\"invariant\"",
			"\"access\"", "EQUAL", "PLUS_ASSIGN", "MINUS_ASSIGN", "STAR_ASSIGN", "DIV_ASSIGN", "MOD_ASSIGN",
			"SR_ASSIGN", "BSR_ASSIGN", "SL_ASSIGN", "BAND_ASSIGN", "BXOR_ASSIGN", "BOR_ASSIGN", "LOR", "LAND", "BXOR",
			"BAND", "NOT_EQUAL", "GT", "LE", "GE", "\"is_a\"", "SL", "SR", "BSR", "PLUS", "MINUS", "STAR", "DIV", "MOD",
			"INC", "DEC", "BNOT", "LNOT", "\"true\"", "\"false\"", "\"this\"", "\"null\"", "\"function\"",
			"\"procedure\"", "\"if\"", "\"else\"", "\"elseif\"", "\"match\"", "\"case\"", "\"while\"", "\"do\"",
			"\"iterate\"", "\"to\"", "\"generic\"", "QUESTION", "\"typeof\"", "\"func\"", "\"proc\"", "\"in\"",
			"\"out\"", "\"ref\"", "\"prop\"", "\"property\"", "\"get\"", "\"set\"", "WS", "SL_COMMENT", "ML_COMMENT",
	...
	public final AccessNotation accessNotation() throws RecognitionException, TokenStreamException {
		...
		acs = pcon.new_AccessNotationImpl();
	...
	public final AliasStatement aliasStatement(OS_Element cont) throws RecognitionException, TokenStreamException {
		AliasStatement pc;

		IdentExpression i1 = null;
		pc = pcon.new_AliasStatementImpl(cont);
	...
	public final AnnotationClause annotation_clause() throws RecognitionException, TokenStreamException {
		...
		a = pcon.new_AnnotationClauseImpl();
		...
		try { // for error handling
			match(ANNOT);
			{
				...
				_loop34: do {
					if ((LA(1) == IDENT)) {
						if (inputState.guessing == 0) {
							ap = pcon.new_AnnotationPartImpl();
						}
						q = qualident();
						if (inputState.guessing == 0) {
							ap.setClass(q);
	...
	public final @Nullable ClassHeader class_header(List<AnnotationClause> as)
			throws RecognitionException, TokenStreamException {
		ClassHeader ch;

		ch = null;
		boolean extends_ = false;
		IdentExpression class_name = null;
		TypeNameList tnl = null;
		...
		try { // for error handling
			...
			match(LITERAL_class);
			if (inputState.guessing == 0) {
				ch = pcon.new_ClassHeaderImpl(extends_, as);
			}
			class_modifier(ch);
			class_name = ident();
			if (inputState.guessing == 0) {
	...
	public final void class_inheritance(ClassHeader ch) throws RecognitionException, TokenStreamException {
	...
	public final void class_modifier(ClassHeader ch) throws RecognitionException, TokenStreamException {
	...
	public final void classInheritance_(ClassInheritance ci) throws RecognitionException, TokenStreamException {
	...
	public final void classInheritanceRuby(ClassInheritance ci) throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			docstrings(cr);
			{
				_loop29: do {
					...
					default:
						if ((LA(1) == IDENT || LA(1) == ANNOT || LA(1) == LITERAL_def)
	...
	public final @Nullable ClassStatement classStatement(OS_Element parent, Context cctx, List<AnnotationClause> as)
			throws RecognitionException, TokenStreamException {
		ClassStatement cls;
		...
		try { // for error handling
			ch = class_header(as);
			if (inputState.guessing == 0) {
				cls = pcon.new_ClassStatementImpl(parent, cctx);
				cls.setHeader(ch);
			}
			match(LCURLY);
			if (inputState.guessing == 0) {
	...
	public final @Nullable IExpression constantValue() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			...
			case STRING_LITERAL: {
				...
				match(STRING_LITERAL);
				if (inputState.guessing == 0) {
					e = pcon.new_StringExpressionImpl(s);
				}
				break;
			}
			case CHAR_LITERAL: {
				...
				match(CHAR_LITERAL);
				if (inputState.guessing == 0) {
					e = pcon.new_CharLitExpressionImpl(c);
				}
				break;
			}
			case NUM_INT: {
				...
				match(NUM_INT);
				if (inputState.guessing == 0) {
					e = pcon.new_NumericExpressionImpl(n);
				}
				break;
			}
			case NUM_FLOAT: {
				...
				match(NUM_FLOAT);
				if (inputState.guessing == 0) {
					e = pcon.new_FloatExpressionImpl(f);
				}
				break;
			}
			default: {
	...
	public final void constructExpression(StatementClosure cr) throws RecognitionException, TokenStreamException {
	...
	public final void constructorDef(ClassStatement cr) throws RecognitionException, TokenStreamException {
	...
	public final @Nullable DefFunctionDef def_function_definition(OS_Element parent, Context ctx,
			List<AnnotationClause> as) throws RecognitionException, TokenStreamException {
		DefFunctionDef fd;

		fd = null;
		FunctionHeader fh = null;
		IExpression fb = null;
		...
		try { // for error handling
			...
			fh = function_header();
			if (inputState.guessing == 0) {
				fd = pcon.new_DefFunctionDefImpl(parent, ctx);
				cur = fd.getContext();
			}
			fb = expression();
			{
	...
	public final void defFunctionDef(DefFunctionDef fd) throws RecognitionException, TokenStreamException {
	...
	public final void destructorDef(ClassStatement cr) throws RecognitionException, TokenStreamException {
	...
	public final @Nullable IExpression dot_expression_or_procedure_call(IExpression e1)
		...
		try { // for error handling
			e = ident();
			if (inputState.guessing == 0) {
				ee = pcon.new_DotExpressionImpl(e1, e);
			}
			{
				if ((LA(1) == LPAREN) && (_tokenSet_59.member(LA(2)))) {
					lp2 = LT(1);
	...
	public final void elseif_part(IfConditional ifex) throws RecognitionException, TokenStreamException {
	...
	public final ExpressionList expressionList() throws RecognitionException, TokenStreamException {
		...
		el = pcon.new_ExpressionListImpl();
	...
	public final FormalArgList formalArgList() throws RecognitionException, TokenStreamException {
		...
		fal = pcon.new_FormalArgListImpl();
	...
	public final void formalArgList_(FormalArgList fal) throws RecognitionException, TokenStreamException {
	...
	public final void formalArgListItem_priv(FormalArgListItem fali) throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			{
				...
				case LITERAL_function: {
					...
					if (inputState.guessing == 0) {
						ctx = pcon.new_FuncExprContext(cur, pc);
						pc.setContext(ctx);
						cur = ctx;
					}
					sco = scope3(pc);
	...
	public final @Nullable FunctionBody function_body(OS_Element parent)
			throws RecognitionException, TokenStreamException {
		FunctionBody fb;
		...
		try { // for error handling
			...
			case LITERAL_property: {
				opt_semi();
				if (inputState.guessing == 0) {
					fb = pcon.new_FunctionBodyEmptyImpl();
				}
				break;
			}
			default: {
	...
	public final FunctionBody function_body_mandatory(OS_Element parent)
			throws RecognitionException, TokenStreamException {
		FunctionBody fb;

		fb = pcon.new_FunctionBodyImpl();
		Scope3 sc = pcon.new_Scope3Impl(parent);
	...
	public final @Nullable BaseFunctionDef function_definition(OS_Element parent, Context ctx,
			List<AnnotationClause> as) throws RecognitionException, TokenStreamException {
		BaseFunctionDef fd;
		...
		try { // for error handling
			switch (LA(1)) {
			case LITERAL_def: {
				fd = (BaseFunctionDef) def_function_definition(parent, ctx, as);
				if (inputState.guessing == 0) {
			...
			case IDENT: {
				fd = (BaseFunctionDef) normal_function_definition(parent, ctx, as);
				if (inputState.guessing == 0) {
	...
	public final FunctionHeader function_header() throws RecognitionException, TokenStreamException {
		...
		fh = pcon.new_FunctionHeaderImpl();
		IdentExpression i1 = null;
		FormalArgList fal = null;
		TypeName tn = null;
	...
	public final Scope3 functionScope(FunctionDef parent) throws RecognitionException, TokenStreamException {
		Scope3 sc;

		sc = pcon.new_Scope3Impl(parent);
		ClassStatement cls = null;
	...
	public final FuncTypeName functionTypeName2_function() throws RecognitionException, TokenStreamException {
		...
		tn = pcon.new_FuncTypeNameImpl(cur);
		TypeName rtn = null;
		TypeNameList tnl = null;
		FormalArgList op = null;
	...
	public final GenericTypeName genericTypeName2() throws RecognitionException, TokenStreamException {
		...
		tn = pcon.new_GenericTypeNameImpl(cur);
		TypeName tn2 = null;
	...
	public final @Nullable IdentExpression ident() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			...
			match(IDENT);
			if (inputState.guessing == 0) {
				id = pcon.new_IdentExpressionImpl(r1, inputState.getFilename(), cur);
			}
		} catch (RecognitionException ex) {
			if (inputState.guessing == 0) {
				reportError(ex);
	...
	public final void importPart1(AssigningImportStatement cr) throws RecognitionException, TokenStreamException {
	...
	public final void importPart2(QualifiedImportStatement cr) throws RecognitionException, TokenStreamException {

		Qualident q3;
		IdentList il = pcon.new_IdentListImpl();
	...
	public final void importPart3(NormalImportStatement cr) throws RecognitionException, TokenStreamException {
	...
	public final @Nullable ImportStatement importStatement(OS_Element el)
			throws RecognitionException, TokenStreamException {
		ImportStatement pc;
		...
		try { // for error handling
			...
			case LITERAL_from: {
				match(LITERAL_from);
				if (inputState.guessing == 0) {
					pc = pcon.new_RootedImportStatement(el);
					ctx = pcon.new_ImportContext(cur, pc);
					pc.setContext(ctx);
					cur = ctx;
				}
				xy = qualident();
			...
			case LITERAL_import: {
				match(LITERAL_import);
				{
					...
					if (synPredMatched40) {
						if (inputState.guessing == 0) {
							pc = pcon.new_AssigningImportStatement(el);
							ctx = pcon.new_ImportContext(cur, pc);
							pc.setContext(ctx);
							cur = ctx;
						}
						...
						if (synPredMatched44) {
							if (inputState.guessing == 0) {
								pc = pcon.new_QualifiedImportStatement(el);
								ctx = pcon.new_ImportContext(cur, pc);
								pc.setContext(ctx);
								cur = ctx;
							}
							...
							if (inputState.guessing == 0) {
								pc = pcon.new_NormalImportStatement(el);
								ctx = pcon.new_ImportContext(cur, pc);
								pc.setContext(ctx);
								cur = ctx;
							}
	...
	public final @Nullable IndexingStatement indexingStatement() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			...
			if (inputState.guessing == 0) {
				idx = pcon.new_IndexingStatementImpl(out.module());
			}
			{
				_loop7: do {
					if ((LA(1) == IDENT)) {
						...
						el = expressionList();
						if (inputState.guessing == 0) {
							item = pcon.new_IndexingItemImpl(i1, el);
							idx.add(item);
						}
					} else {
						break _loop7;
		...
		try { // for error handling
			match(LITERAL_invariant);
			{
				_loop173: do {
					if ((_tokenSet_18.member(LA(1)))) {
						if (inputState.guessing == 0) {
							isp = pcon.new_InvariantStatementPartImpl(cr, i1);
						}
						{
	...
	public final void namespaceStatement(NamespaceStatement cls, List<AnnotationClause> as)
		...
		try { // for error handling
			...
			match(LCURLY);
			if (inputState.guessing == 0) {
				ctx = pcon.new_NamespaceContext(cur, cls);
				cls.setContext(ctx);
				cur = ctx;
			}
			namespaceScope(cls);
	...
	public final @Nullable FunctionDef normal_function_definition(OS_Element parent, Context ctx,
			List<AnnotationClause> as) throws RecognitionException, TokenStreamException {
		FunctionDef fd;
		...
		try { // for error handling
			fh = function_header();
			if (inputState.guessing == 0) {
				fd = pcon.new_FunctionDefImpl(parent, ctx);
				cur = fd.getContext();
			}
			fb = function_body(fd);
			if (inputState.guessing == 0) {
	...
	public final NormalTypeName normalTypeName2() throws RecognitionException, TokenStreamException {
		...
		tn = pcon.new_RegularTypeNameImpl(cur);
	...
	public final Postcondition postcondition() throws RecognitionException, TokenStreamException {
		...
		postc = pcon.new_PostconditionImpl();
	...
	public final void postConditionSegment(FunctionBody sc) throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			ee = primaryExpression();
			{
				_loop225: do {
					if ((LA(1) == DOT) && (LA(2) == IDENT)) {
						...
						match(RBRACK);
						if (inputState.guessing == 0) {
							ee = pcon.new_GetItemExpressionImpl(ee, expr);
						...
						}
						{
							if ((LA(1) == BECOMES) && (_tokenSet_18.member(LA(2)))) {
								...
								expr = expression();
								if (inputState.guessing == 0) {
									ee = pcon.new_SetItemExpressionImpl((GetItemExpression) ee, expr);
								}
							} else if ((_tokenSet_7.member(LA(1))) && (_tokenSet_56.member(LA(2)))) {
							} else {
								throw new NoViableAltException(LT(1), getFilename());
			...
			}
			{
				if ((LA(1) == AS || LA(1) == CAST_TO) && (_tokenSet_61.member(LA(2)))) {
					if (inputState.guessing == 0) {
						tc = pcon.new_TypeCastExpressionImpl();
						ee = tc;
					}
					{
						switch (LA(1)) {
	...
	public final Precondition precondition() throws RecognitionException, TokenStreamException {
		...
		prec = pcon.new_PreconditionImpl();
		IdentExpression id = null;
	...
	public final void preConditionSegment(FunctionBody sc) throws RecognitionException, TokenStreamException {
	...
	public final @Nullable IExpression primaryExpression() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			...
			case LPAREN: {
				...
				match(RPAREN);
				if (inputState.guessing == 0) {
					ee = pcon.new_SubExpressionImpl(ee);
				}
				break;
			}
			case LCURLY:
			...
			case LBRACK: {
				match(LBRACK);
				if (inputState.guessing == 0) {
					ee = pcon.new_ListExpressionImpl();
					el = pcon.new_ExpressionListImpl();
				}
				el = expressionList();
				if (inputState.guessing == 0) {
	...
	public final void program() throws RecognitionException, TokenStreamException {
		...
		ModuleContext mctx = pcon.new_ModuleContext(out.module());
				...
				_loop4: do {
					...
					case LITERAL_package: {
						...
						if (inputState.guessing == 0) {
							...
							cur = pcon.new_PackageContext(cur, pkg);
	...
	public final void programStatement(/* ProgramClosure pc, */ OS_Element cont)
			throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			...
			case LITERAL_namespace: {
				...
				}
				{
					switch (LA(1)) {
					case LITERAL_namespace: {
						namespaceStatement(pcon.new_NamespaceStatementImpl(cont, cur), as);
						break;
					}
					case LITERAL_extend:
					case LITERAL_class: {
	...
	public final void propertyStatement(PropertyStatement ps) throws RecognitionException, TokenStreamException {
	...
	public final QualidentList qualidentList2() throws RecognitionException, TokenStreamException {
		...
		Qualident qid;
		qal = pcon.new_QualidentListImpl();
	...
	public final void regularQualifiers2(NormalTypeName fp) throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			ee = shiftExpression();
			{
				if ((_tokenSet_7.member(LA(1))) && (_tokenSet_56.member(LA(2)))) {
					...
					tn = typeName2();
					if (inputState.guessing == 0) {
						ee = pcon.new_TypeCheckExpressionImpl(ee, tn);
					}
				} else {
					throw new NoViableAltException(LT(1), getFilename());
				}
	...
	public final Scope3 scope3(OS_Element parent) throws RecognitionException, TokenStreamException {
		Scope3 sc;
	...
	public final void statement(StatementClosure cr, OS_Element aParent)
			throws RecognitionException, TokenStreamException {
	...
	public final void syntacticBlockScope(OS_Element aParent) throws RecognitionException, TokenStreamException {

		SyntacticBlock sb = pcon.new_SyntacticBlockImpl(aParent);
		SyntacticBlockContext ctx = null;

		try { // for error handling
			if (inputState.guessing == 0) {
				ctx = pcon.new_SyntacticBlockContext(sb, cur);
				sb.setContext(ctx);
				cur = ctx;
			}
			sco = scope3(sb);
	...
	public final @Nullable TypeAliasStatement typeAlias(OS_Element cont)
			throws RecognitionException, TokenStreamException {
		TypeAliasStatement cr;

		TypeAliasBuilder tab = pcon.new_TypeAliasBuilder();
		cr = null;
	...
	public final void typeAlias2(TypeAliasBuilder tab) throws RecognitionException, TokenStreamException {
	...
	public final TypeOfTypeName typeOfTypeName2() throws RecognitionException, TokenStreamException {
		...
		tn = pcon.new_TypeOfTypeNameImpl(cur);
	...
	public final @Nullable IExpression unaryExpression() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			...
			case INC: {
				...
				ee = unaryExpression();
				if (inputState.guessing == 0) {
					ee = pcon.new_UnaryExpressionImpl(ExpressionKind.INCREMENT, ee);
				}
				break;
			}
			case DEC: {
				...
				ee = unaryExpression();
				if (inputState.guessing == 0) {
					ee = pcon.new_UnaryExpressionImpl(ExpressionKind.DECREMENT, ee);
				}
				break;
			}
			case MINUS: {
				...
				ee = unaryExpression();
				if (inputState.guessing == 0) {
					ee = pcon.new_UnaryExpressionImpl(ExpressionKind.NEG, ee);
				}
				break;
			}
			case PLUS: {
				...
				ee = unaryExpression();
				if (inputState.guessing == 0) {
					ee = pcon.new_UnaryExpressionImpl(ExpressionKind.POS, ee);
				}
				break;
			}
			case IDENT:
	...
	public final @Nullable IExpression unaryExpressionNotPlusMinus() throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			...
			case BNOT: {
				...
				ee = unaryExpression();
				if (inputState.guessing == 0) {
					ee = pcon.new_UnaryExpressionImpl(ExpressionKind.BNOT, ee);
				}
				break;
			}
			case LNOT: {
				...
				ee = unaryExpression();
				if (inputState.guessing == 0) {
					ee = pcon.new_UnaryExpressionImpl(ExpressionKind.LNOT, ee);
				}
				break;
			}
			case IDENT:
	...
	public final void varStmt(StatementClosure cr, OS_Element aParent)
			throws RecognitionException, TokenStreamException {
	...
	public final void varStmt_i(VariableStatement vs) throws RecognitionException, TokenStreamException {
	...
	public final void varStmt_i3(VariableStatement vs) throws RecognitionException, TokenStreamException {
	...
	public final void withStatement(OS_Element aParent) throws RecognitionException, TokenStreamException {
		...
		try { // for error handling
			...
			if (inputState.guessing == 0) {
				ctx = pcon.new_WithContext(ws, cur);
				ws.setContext(ctx);
				cur = ctx;
			}
			sco = scope3(ws);
