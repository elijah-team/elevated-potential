...
import tripleo.elijah.ci.CiBasicBinaryExpression;
...
public class CiBasicBinaryExpressionImpl implements CiBasicBinaryExpression {
	public CiExpressionKind _kind;
	private CiExpressionList args;
	public  CiExpression    left;
	public  CiExpression    right;

	public CiBasicBinaryExpressionImpl() {
		left  = null;
		right = null;
		_kind = null;
	}

	public CiBasicBinaryExpressionImpl(final CiExpression aLeft, final CiExpressionKind aType, final CiExpression aRight) {
		left  = aLeft;
		_kind = aType;
		right = aRight;
	}
	...
	@Override
	public void set(final CiBinaryExpression aEx) {
		left  = aEx.getLeft();
		_kind = aEx.getKind();
		right = aEx.getRight();
	}
	...
	@Override
	public void shift(final CiExpressionKind aType) {
		left  = new CiBasicBinaryExpressionImpl(left, _kind, right); // TODO
		_kind = aType;
		right = null;
	}
	...
	@Override
	public void setKind(final CiExpressionKind aKind) {
		_kind = aKind;
	}
