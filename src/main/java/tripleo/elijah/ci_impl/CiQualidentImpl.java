...
public class CiQualidentImpl implements CiQualident {
	private final List<CiIdentExpression> parts = new ArrayList<>();
...
//		_syntax.appendDot(d1, parts.size());//parts.add(d1);
	...
	public String asSimpleString() {
		return __Ci__Helpers.String_join(".", Collections2.transform(parts, new Function<CiIdentExpression, String>() {
			@Nullable
			@Override
