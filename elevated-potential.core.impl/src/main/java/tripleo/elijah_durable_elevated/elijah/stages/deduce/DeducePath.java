...
import tripleo.elijah_durable_elevated.elijah.stages.deduce.nextgen.DR_IdentUnderstandings;
...
//			if (index == 0)
			...
			if (type.getResolved() == null) {
				...
				if (ell == null) {
					...
					if (ell instanceof final VariableStatementImpl variableStatement) {
